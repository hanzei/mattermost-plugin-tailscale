	...
	if err := p.API.RegisterCommand(&model.Command{
		...
		AutocompleteData: &model.AutocompleteData{
			...
			SubCommands: []*model.AutocompleteData{
				{
					Trigger:  "connect",
					Hint:     "<tailnet> <api-key>",
					HelpText: "Connect to your Tailscale network",
				},
				{
					Trigger:  "disconnect",
					HelpText: "Disconnect from your Tailscale network",
				},
				{
					Trigger:  "list",
					HelpText: "List all devices in your Tailnet",
				},
				{
					Trigger:  "acl",
					HelpText: "Show the ACL configuration for your Tailnet",
				},
				{
					Trigger:  "tailnet",
					HelpText: "Show your current Tailnet name",
				},
			},
		},
